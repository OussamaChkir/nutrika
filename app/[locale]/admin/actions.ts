        ...
        await prisma.$transaction([
            prisma.product.update({
                ...
                data: {
                    ...
                    allergens: changes.allergens !== undefined ? (changes.allergens as string[]) : contribution.product.allergens,
                    allergensSeverity: (changes.allergensSeverity as "LOW" | "MEDIUM" | "HIGH") || contribution.product.allergensSeverity,
                    manufacturingPlaces: changes.manufacturingPlaces !== undefined ? (changes.manufacturingPlaces as string) : contribution.product.manufacturingPlaces,
                    origins: changes.origins !== undefined ? (changes.origins as string) : contribution.product.origins,
                    dietaryTags: changes.dietaryTags !== undefined ? (changes.dietaryTags as string[]) : contribution.product.dietaryTags,
                    status: "APPROVED",
                    approvedAt: new Date(),
                },
            }),
