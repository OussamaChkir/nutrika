                        ...
                        {[
                            {
                                ...
                                detail: "Very high sugar (>22.5g) costs -20 pts, high sugar (>10g) costs -10 pts, low sugar (<5g) earns +3 pts; high sat. fat (>5g) costs -10 pts, low sat. fat (<1.5g) earns +3 pts",
                            },
                            {
                                icon: CircleAlert,
                                label: "Salt Excess",
                                ...
                                iconColor: "text-orange-500",
                                detail: "Salt over 1.5g per 100g costs -10 pts; salt under 0.3g earns +3 pts",
                            },
                            {
                                icon: Salad,
                                label: "Fiber & Protein",
                                ...
                                detail: "High fiber (>3g) and high protein (>10g) each earn +8 bonus points",
                            },
                            {
                                icon: Factory,
                                ...
                                detail: "NOVA 4 (ultra-processed) gets -10 pts, NOVA 3 gets -5 pts, NOVA 1 (unprocessed) gets +8 pts",
                            },
                            {
                                icon: FlaskConical,
                                label: "Additives",
                                ...
                                detail: "Each controversial additive (MSG, aspartame, artificial colors) costs -6 pts (capped at -20); no additives earns +5 pts",
                            },
                            {
                                icon: Leaf,
